...
struct MappingFragment {
	...
	std::unique_ptr<MappingFragment> frags[numFrags];
...
MappingFragment& MappingFragment::operator() (unsigned bits) {
	...
	if (!frag)
		frag = llhd::make_unique<MappingFragment>(gen);
	return *frag;
}
...
int main(int argc, char** argv) {
	...
	fout << "/* This file was automatically generated. DO NOT MODIFY. */\n";
	fout << "#include \"src/unicode/casefolding-internal.hpp\"\n";
	fout << std::hex;
