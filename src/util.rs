...
where T: std::fmt::Display, I: std::iter::Iterator<Item=T>, S: std::fmt::Display {
...
pub fn write_implode_with<T,I,S,F>(f: &mut std::fmt::Formatter, sep: S, mut it: I, write: F) -> std::fmt::Result
where I: std::iter::Iterator<Item=T>, S: std::fmt::Display, F: Fn(&mut std::fmt::Formatter, T) -> std::fmt::Result {
