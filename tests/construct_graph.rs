...
fn simple_func() {
    ...
    let mut func = llhd::Function::new("foo".into(), func_ty.clone());
    {
        ...
        let inst = body.add_inst(
            Inst::new(
                None,
                BinaryInst(BinaryOp::Add, llhd::int_ty(32), a.into(), b.into()),
            ),
            InstPosition::End,
        );
        ...
        let inst = body.add_inst(
            Inst::new(
                Some("y".into()),
                BinaryInst(BinaryOp::Add, llhd::int_ty(32), inst.into(), konst.into()),
            ),
            InstPosition::End,
        );
    ...
    let mut prok = llhd::Process::new("bar".into(), proc_ty.clone());
    {
        ...
        body.add_inst(
            Inst::new(
                ...
                BinaryInst(
                    ...
                    llhd::int_ty(32),
                    a.into(),
                    llhd::const_int(32, 21.into()).into(),
                ),
            ),
            InstPosition::End,
        );
        body.add_inst(
            Inst::new(
                None,
                CallInst(func_ty.clone(), func.into(), vec![a.into(), a.into()]),
            ),
            InstPosition::End,
        );
    }
    ...
    let mut entity = llhd::Entity::new("top".into(), proc_ty.clone());
    {
        ...
        entity.add_inst(
            Inst::new(
                ...
                BinaryInst(
                    ...
                    llhd::int_ty(32),
                    a.into(),
                    llhd::const_int(32, 9000.into()).into(),
                ),
            ),
            InstPosition::End,
        );
        entity.add_inst(
            Inst::new(
                None,
                InstanceInst(proc_ty.clone(), prok.into(), vec![a.into()], vec![b.into()]),
            ),
            InstPosition::End,
        );
    }
